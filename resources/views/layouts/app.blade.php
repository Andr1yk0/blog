...
<body class="theme-green bg-text-clr-100">
    ...
    <footer class="bg-text-clr-50 mt-6 shadow">
        <div class="mx-auto max-w-7xl p-6 md:flex md:items-center md:justify-between">
            <div class="flex justify-center space-x-6 md:order-2">
                <a href="https://github.com/Andr1yk0" target="_blank" class="text-text-clr-400 hover:text-text-clr-500">
                ...
                <a href="https://www.linkedin.com/in/andriy-lozynskyy-2a64a898/" target="_blank" class="text-text-clr-400 hover:text-text-clr-500">
            ...
            <div class="mt-8 md:order-1 md:mt-0">
                <p class="text-center text-xs leading-5 text-text-clr-500">&copy; 2023 prostocode.com. All rights reserved.</p>
            </div>
        </div>
    </footer>
</div>
