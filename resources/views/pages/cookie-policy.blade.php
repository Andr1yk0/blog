        ...
        <x-card class="mx-auto max-w-[65ch]">
            <div class="prose prose-base prose-h1:text-center">
                ...
                <ul>
                    ...
                    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to ProstoCode, that is
                    ...
                    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can
                        be used to visit ProstoCode and use the services.
                    </li>
                    ...
                    <li>Service: refers to the service provided by ProstoCode as described in the relative terms (if
                    ...
                    <li>Website: site, which can be accessed via this URL: https://prostocode.com/</li>
                </ul>
                ...
                <p>Cookies can either be session cookies or persistent cookies. A session cookie expires automatically when
                    ...
                    expire after multiple years. Cookies placed by the website you’re visiting are called “first party
                    cookies”.</p>
                ...
                <p>We use cookies served by Google Analytics to collect limited data directly from end-user browsers to
                    enable us to better understand your use of our website. Further information on how Google collects and
                ...
                <p>Most browsers allow you to control cookies through their 'settings' preferences. However, if you limit
                    ...
                    information. Browser manufacturers provide help pages relating to cookie management in their
                    products.</p>
