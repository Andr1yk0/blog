                ...
                <form action="{{ route('contacts.store') }}" id="contactForm" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            <label for="name" class="block text-sm font-semibold leading-6 text-gray-900">Your
                                name</label>
                            <div class="mt-2.5">
                                <input type="text"
                                       name="name"
                    ...
                    <div class="mt-10">
                        <button type="submit"
                                ...
                                class="g-recaptcha block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                            Let's talk
                        </button>
                    </div>
